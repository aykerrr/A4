<%-- 
    Document   : index
    Created on : 30/09/2023, 18:25:34
    Author     : LISS
--%>
    ...
    <body>
        ...
        <div class="container">
            <form action="sr_empleado" method="post" class="form-group">
                ...
                <input type="number" name="txt_telefono" id="txt_telefono" class="form-control" placeholder="Ejemplo: 34940995" required>        
                <label for="lbl_fn"><b>Fecha_nacimiento:</b></label>
                <input type="date" name="txt_fn" id="txt_fn" class="form-control" required>
                <label for="lbl_puesto"><b>Puesto:</b></label>
                <select name="drop_puesto" id="drop_puesto" class="form-control">
                     <optio value="1">Opcion 1</option>
                     <optio value="2">Opcion 2</option>
                     <optio value="3">Opcion 3</option>
                </select>
                 <br>
                 <button type="button" name="btn_agregar" id="btn_agregar" class="btn btn-primary btn-lg">
                 </from>
